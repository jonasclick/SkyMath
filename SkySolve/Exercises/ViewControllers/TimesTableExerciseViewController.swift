//
//  TimesTableExerciseViewController.swift
//  MentalMath
//
...
class TimesTableExerciseViewController: UIViewController, KeyboardCollectionViewControllerDelegate {
    ...
    let subtitle: UILabel = {
        let label = UILabel()
        label.text = "Do good an good will come your way."
    ...
    override func viewDidLoad() {
        ...
        mainTitle.text = "The \(timesTable) Times Table"
    ...
    private func setProblem() {
        let int = Int.random(in: 1...55) // Not sure why I picked 55
        
        currentSolution = int * timesTable
        question.text = "\(int) × \(timesTable)"
        answerField.text = ""
    }
...
#Preview {
    TimesTableExerciseViewController(timesTable: 3)
}
