//
//  NauticalMilesExerciseViewController.swift
//  MentalMath
//
...
class NauticalMilesExerciseViewController: UIViewController, KeyboardCollectionViewControllerDelegate {
    ...
    let subtitle: UILabel = {
        let label = UILabel()
        label.text = "1 NM = 1.852 km but in this exercise 1 NM = 2 km"
    ...
    private func setProblem() {
        let nauticalMiles = Int.random(in: 1...300)
        
        currentSolution = nauticalMiles * 2
        question.text = "\(nauticalMiles) NM in km"
        answerField.text = ""
    }
...
#Preview {
    NauticalMilesExerciseViewController()
}
