//
//  FeetExerciseViewController.swift
//  MentalMath
//
...
class FeetExerciseViewController: UIViewController, KeyboardCollectionViewControllerDelegate {
    ...
    let subtitle: UILabel = {
        let label = UILabel()
        label.text = "1 ft = 0.3048m but in this exercise 1ft = 0.3m"
    ...
    private func setProblem() {
        let multiplier = Int.random(in: 1...55)
        let feet = 1000 * multiplier
        
        currentSolution = multiplier * 300
        
        question.text = "\(feet) ft in m"
        answerField.text = ""
    }
