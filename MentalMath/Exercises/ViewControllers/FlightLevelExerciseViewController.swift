//
//  FlightLevelExerciseViewController.swift
//  MentalMath
//
...
class FlightLevelExerciseViewController: UIViewController, KeyboardCollectionViewControllerDelegate {
...
#Preview {
    FlightLevelExerciseViewController()
}
