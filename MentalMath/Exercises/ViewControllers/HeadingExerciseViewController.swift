//
//  HeadingExerciseViewController.swift
//  MentalMath
//
...
class HeadingExerciseViewController: UIViewController, KeyboardCollectionViewControllerDelegate {
    ...
    let subtitle: UILabel = {
        let label = UILabel()
        label.text = "Name the opposite heading."
    ...
    private func setProblem() {
        let heading = Int.random(in: 1...360)
